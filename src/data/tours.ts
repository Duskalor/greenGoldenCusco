...
export const toursES: Tour[] = [
  {
    id: 'machu-picchu', name: 'Machu Picchu', tag: 'Maravilla del Mundo', duration: 'Full Day',
    price: 'S/. 350', description: 'Descubre la ciudadela inca más emblemática del planeta, rodeada de montañas y misterio ancestral.',
  ...
  {
    id: 'montana-7-colores', name: 'Montaña 7 Colores', tag: 'Ícono Natural', duration: 'Full Day',
    price: 'S/. 80', description: 'Camina entre paisajes surrealistas hasta uno de los escenarios más impresionantes del Perú.',
  ...
  {
    id: 'laguna-humantay', name: 'Laguna Humantay', tag: 'Naturaleza Pura', duration: 'Full Day',
    price: 'S/. 70', description: 'Una laguna turquesa al pie de glaciares milenarios. Un espectáculo visual inolvidable.',
  ...
  {
    id: 'city-tour', name: 'City Tour Cusco', tag: 'Centro Histórico', duration: 'Medio Día',
    price: 'S/. 50', description: 'Recorre la esencia de la ciudad imperial: Sacsayhuamán, Qenqo, la Catedral y el Qoricancha.',
  ...
  {
    id: '7-lagunas', name: '7 Lagunas Ausangate', tag: 'Aventura Andina', duration: 'Full Day',
    price: 'S/. 90', description: 'Siete lagunas de colores intensos rodeadas de montañas nevadas. Para amantes del trekking.',
  ...
  {
    id: 'camino-inca', name: 'Camino Inca Clásico', tag: 'Trekking Legendario', duration: '4D / 3N',
    price: 'S/. 1,800', description: 'La ruta ancestral de 43 km hasta Machu Picchu. Campamentos, ruinas y paisajes que cambian tu vida.',
  ...
  {
    id: 'salkantay', name: 'Salkantay Trekking', tag: 'Ruta Alternativa', duration: '5D / 4N',
    price: 'S/. 1,200', description: 'La alternativa épica al Camino Inca. Glaciares, selva alta y Machu Picchu en 5 días.',
  ...
  {
    id: 'lares', name: 'Lares Trekking', tag: 'Cultura Viva', duration: '4D / 3N',
    price: 'S/. 950', description: 'Trekking cultural por comunidades quechuas, aguas termales y paisajes andinos auténticos.',
  ...
  {
    id: 'palccoyo', name: 'Palccoyo', tag: '7 Colores Alternativo', duration: 'Full Day',
    price: 'S/. 70', description: 'Tres montañas de colores con caminata suave. La alternativa perfecta a Vinicunca.',
